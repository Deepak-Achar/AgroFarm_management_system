							...
							<form method="post" action="Login/signUp.php" >
								...
								<div class="row uniform">
									<div class="3u 12u$(xsmall)">
										<input type="text" name="name" id="name" pattern="^[A-Z a-z]*$" value="" placeholder="Name" required/>
									</div>
									<div class="3u 12u$(xsmall)">
								...
								<div class="row uniform">
									<div class="6u 12u$(xsmall)">
										<input type="text" n+ame="addr" id="addr" value="" placeholder="Address" style="width:80%" required/>
									</div>
								</div>
								<div class="row uniform">
										<p>
